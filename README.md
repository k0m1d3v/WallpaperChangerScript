Hi, this little script allows you to change the wallpaper of a computer from the cmd, for make it work just install all the necessaries imports and then start the script.
